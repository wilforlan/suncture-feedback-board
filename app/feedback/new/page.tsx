...
async function getNextSerialNumberClient(): Promise<string> {
  try {
    ...
    console.error("Error in getNextSerialNumberClient:", error)
    return "BUG-001"
  }
}

// Client-side implementation for submitting feedback
async function submitFeedbackClient(formData: any) {
  try {
    ...
    if (error) {
      ...
      return { success: false, message: "Error submitting feedback: " + error.message }
    }
...
export default function NewFeedbackPage() {
  ...
  useEffect(() => {
    ...
    const fetchSerialNumber = async () => {
      try {
        const nextSerialNumber = await getNextSerialNumberClient()
        setSerialNumber(nextSerialNumber)
      } catch (error) {
        console.error("Error fetching serial number:", error)
        setSerialNumber("BUG-001")
      }
    }
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400">Help improve the Suncture Platform by reporting issues</p>
          </div>
        </div>
      </div>
      ...
      {!user ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>You need to be logged in to submit feedback</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="mb-4">Please log in or create an account to submit feedback.</p>
            <Button asChild>
        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <CardHeader>
            <CardTitle>New Feedback Report</CardTitle>
            <CardDescription>
              Fill out the form below to submit your feedback about the Suncture Platform
            </CardDescription>
          </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-center py-4">
                      <RadioGroup
                        ...
                        onValueChange={(value) => setChatbotRating(Number(value))}
